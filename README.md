...
_This is a fork of [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) as a starting point for my own configuration_

A starting point for Neovim that is small, modular, completely documented.

**NOT** a Neovim distribution, but instead my configuration that was started
from dam900/kickstart-modular.nvim.
